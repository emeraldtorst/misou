export const translations: Record<string, any> = {
  en: {
    ...
    mosaic: {
      ...
      title: "Every plate.\nEvery moment.",
      subtext: "A visual archive of culinary craftsmanship and architectural atmosphere."
    },
    menu: {
      ...
      items: {
        ...
        truffleTuna: "Bluefin tuna, truffle paste, cucumber, crispy tempura flakes.",
        sashimi: "Selection of 12 slices of fresh raw fish (Salmon, Tuna, Seabass).",
    ...
    reviews: {
      ...
      r4Role: "Google Local Guide",
      r4Date: "1 month ago"
    },
    booking: {
      sub: "EXPERIENCE MISO·U",
      title: "Secure Your Seat at the Table",
      text: "Due to intimate seating layout, we highly recommend planning your reservation in advance. Enjoy custom-tailored dinner tasting journeys or custom drink pairings.",
      reserve: "Create Reservation"
    },
    contact: {
      title: "Location & Contact",
      labelAddress: "Address",
      labelReservations: "Reservations & Enquiries",
      labelHours: "Opening Hours",
      daysWeek: "Tuesday – Friday",
      timeWeek: "11:00 am – 10:00 pm",
      daysWeekend: "Saturday – Sunday",
      timeWeekend: "12:00 pm – 10:00 pm",
      dayMonday: "Monday",
      closed: "Closed"
    },
    footer: {
      ...
      inquiries: "Inquiries",
      book: "Book Table",
      privacyTitle: "Declaration of Information Obligation",
      privacyIntro1: "In the following privacy policy, we inform you about the key aspects of data processing within our website. We collect and process personal data only on the basis of legal regulations.",
      privacyIntro2: "As soon as you access or visit our website as a user, your IP address, start, and end of the session are recorded. This is technically necessary and therefore constitutes a legitimate interest according to Art. 6 Para. 1 GDPR.",
      imprintTitle: "Imprint",
      imprintSub: "Information and Disclosure",
      imprintECG: "according to §5 (1) ECG, § 25 MedienG, § 63 GewO and § 14 UGB",
      operator: "Website Operator",
      regNumber: "Commercial Register No.",
  ...
  de: {
    ...
    mosaic: {
      ...
      title: "Jeder Teller.\nJeder Moment.",
      subtext: "Ein visuelles Archiv kulinarischer Handwerkskunst und architektonischer Atmosphäre."
    },
    menu: {
      ...
      items: {
        ...
        truffleTuna: "Blauflossen-Thunfisch, Trüffelpaste, Gurke, knusprige Tempura-Flocken.",
        sashimi: "Auswahl an 12 Scheiben frischem, rohem Fisch (Lachs, Thunfisch, Wolfsbarsch).",
    ...
    booking: {
      sub: "ERLEBEN SIE MISO·U",
      title: "Sichern Sie sich Ihren Tisch",
      text: "Aufgrund unseres intimen Raumkonzepts empfehlen wir dringend, Ihre Reservierung im Voraus zu planen. Genießen Sie maßgeschneiderte Degustationsmenüs oder feine Getränkebegleitungen.",
      reserve: "Tisch Reservieren"
    },
    contact: {
      title: "Lage & Kontakt",
      labelAddress: "Adresse",
      labelReservations: "Reservierungen & Anfragen",
      labelHours: "Öffnungszeiten",
      daysWeek: "Dienstag – Freitag",
      timeWeek: "11:00 – 22:00 Uhr",
      daysWeekend: "Samstag – Sonntag",
      timeWeekend: "12:00 – 22:00 Uhr",
      dayMonday: "Montag",
      closed: "Geschlossen"
    },
    footer: {
      ...
      privacyTitle: "Erklärung zur Informationspflicht",
      privacyIntro1: "In folgender Datenschutzerklärung informieren wir Sie über die wichtigsten Aspekte der Datenverarbeitung im Rahmen unserer Webseite. Wir erheben und verarbeiten personenbezogene Daten nur auf Grundlage der gesetzlichen Bestimmungen.",
      privacyIntro2: "Sobald Sie als Benutzer auf unsere Webseite zugreifen oder diese besuchen wird Ihre IP-Adresse, Beginn sowie Beginn und Ende der Sitzung erfasst. Dies ist technisch bedingt und stellt somit ein berechtigtes Interesse iSv Art 6 Abs 1 lit f DSGVO.",
      imprintTitle: "Impressum",
      imprintSub: "Informationen und Offenlegung",
      imprintECG: "gemäß §5 (1) ECG, § 25 MedienG, § 63 GewO und § 14 UGB",
      operator: "Webseitenbetreiber",
      regNumber: "Firmenbuchnummer",
      court: "Firmenbuchgericht",
      address: "Anschrift",
      authority: "Gewerbeaufsichtsbehörde",
